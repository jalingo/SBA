...
struct TextFactory: StringFactory {
    ...
    fileprivate static func unattributedString(for index: Int) -> String {
        ...
        case 2:     return "There are several grant, loan and bond opportunities available through the Small Business Administration (sba.gov)."
        case 3:     return "In industries where there is demand for high quality American products, small US companies have growth potential abroad."
        case 4:     return "A business should identify value for its customers, but it should also determine the value its customers represent."
        case 5:     return "For every group of potential customers you identify, you should find out as much as you can about what they think of your products / services."
        case 6:     return "Incorporate the notion of customer value and recognize that this notion can change over time."
        case 7:     return "The complexity and difficulty of a comprehensive business plan can be reduced by using an available business-planning software package like liveplan.com, lawdepot.com, businessplanpro.com, etc..."
        case 8:     return "The ability to accurately forecast is critical for any business."
        ...
        case 13:    return "There are a variety of techniques, including brainstorming and mind mapping, that can structure thinking and facilitate creativity."
        case 14:    return "A Pricing Strategy requires clearly enumerated Pricing Objectives."
        case 15:    return "Common Pricing Strategies include Discount Pricing, Cost Based Pricing, Prestige Pricing, Even Odd Pricing and Geographic Pricing."
        ...
        case 18:    return "Market Segments can be divided down to an even more granular level, to produce isolated niches of unmet needs."
        ...
        case 21:    return "60% of small businesses fail within 2 years of experiencing a major disaster. Have a Disaster Recovery Plan that incorporates appropriate insurance packages."
        case 22:    return "A successful Disaster Recovery Plan must cover communications, investment protection and mechanisms to continue operations."
        ...
        case 29:    return "Marketing Research, Planning and Campaigns are universally adopted because they work."
        case 30:    return "Customer Value is equal to Perceived Benefits less Perceived Costs, and can be categorized as Functional, Social, Epistemic, Emotional and Conditional."
        ...
        case 34:    return "Every Marketing Plan should explain how to implement, evaluate and control the process. Include an Executive Summary, Vision / Mission statements, Situation Analysis, Marketing Objectives / Strategy and Financials. "
        ...
        case 37:    return "Social Media lends itself well to Marketing Campaigns with little to no budget. For B2B, start with LinkedIn.com. For B2C make sure you have a presence on facebook.com, twitter.com and yelp.com."
        case 38:    return "Small business owners should be familiar and comfortable with the terms promotion, marketing communications and integrated marketing communications (IIMC). Wikipedia.org is a great place for term definitions and concepts."
        ...
        case 41:    return "Marketing is the only activity that generates leads and traffic for most small businesses, essential for revenue."
        ...
        case 58:    return "CRM software was formerly so complex and expensive that it was only suitable for large corporations. Now it can be used to improve customer value at any size level."
        ...
        case 61:    return "The initial time and effort investment to configure automation has a huge return, when designed and implemented properly."
        ...
        case 66:    return "Small businesses can be proactive in preserving cash flow through a variety of simple actions including expense tracking, projecting future sales and automation."
        ...
        case 82:    return "Financial ratios reduce a large amount of data into more manageable units that can be used to make comparisons of different firms in a particular industry."
        ...
        case 87:    return "Selecting an accounting service should be a careful considerederation of the following: expertise in a particular type of business or industry, rapport, availability of additional consulting services and the ability to support automation."
        case 88:    return "Accounting systems may be divided into two major types: cash basis and accrual basis."
        case 89:    return "Succession planning is to ensuring the proper passing of a family business to family members."
        case 90:    return "Hiring Process: Identify Job Requirements, Choose Sources of Candidates, Review Applications and CV’s, Interview Candidates, Conduct Employment Tests (if desired), Check References, Conduct Follow-Up Interviews (if needed), Select a Candidate and Make an Offer."
        case 91:    return "Good leaders are dynamic, adapting their style to a given situation. These styles are often a mix of Autocratic, Democratic and Laissez-Faire. Bad leaders are incapable of adapting, with only a single style to rely on."
        case 92:    return "The costs of unethical behavior can be staggering."
        ...
        case 96:    return "Tech advances that help Small businesses compete against larger firms also increase the chance they're targeted for cybercrime. Small businesses must pay attention to their website security, because it will protect the business and influence customer trust."
        ...
        case 101:   return "The most common forms of legal structure are the sole proprietorship, the partnership, and the corporation. An S-Corp is a relatively new business structure."
        case 102:   return "Avoid stress and high fees by using sites like clerky.com, to ensure your legal paperwork is done correctly."
        ...
        default:    return "A Patent grants you “the right to exclude others from making, using, offering for sale, or selling” an invention in the United States for twenty years."
        }
    }
}
